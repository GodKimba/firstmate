...
FM_INHERITABLE_CONFIG="${FM_INHERITABLE_CONFIG:-crew-dispatch.json crew-harness claude-pool backlog-backend backend herdr-presentation-spaces startup-memory-budget}"
