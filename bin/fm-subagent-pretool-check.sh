...
# Scope to a genuine primary launch and home, exactly as the session-start nudge
# and turn-end guard do. bin/fm-primary-scope-lib.sh owns launch identity,
# secondmate-marker inclusion, the checkout-shape backstop, and required paths.
# Ordinary crewmate delegation stays allowed. Any failure to confirm the home is
