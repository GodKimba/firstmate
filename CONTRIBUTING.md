...
CI routing, complete-suite coverage, timing evidence, concurrency policy, and artifact posture are documented in [`docs/fm-test-portable-shards.md`](docs/fm-test-portable-shards.md), while [`.github/workflows/ci.yml`](.github/workflows/ci.yml) owns executable wiring.
