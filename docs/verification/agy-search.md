...
ok - agy command construction, structured parsing, retries, cancellation, cache separation, and failure output are deterministic
...
ok - web_fetch retains private-redirect and response-size protections
```
