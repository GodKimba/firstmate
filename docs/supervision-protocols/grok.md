...
6. Failure or missing cycle only: `watcher: FAILED ...` means supervision is down; fix and re-arm.
   If the arm reports an away-mode stand-down, stop this continuity path and load `/afk`; [`watcher-continuity.md`](../watcher-continuity.md) owns the full stand-down contract.
