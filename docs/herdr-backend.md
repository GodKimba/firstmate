...
Its before/after tripwire requires the exact named fleet-session snapshot, including its socket path, to remain byte-identical and revalidates the recorded pane for an ambient Herdr caller.
