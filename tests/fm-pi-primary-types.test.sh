...
cp "$ROOT/.pi/extensions/gemini-search.ts" "$TMP_ROOT/gemini-search.ts"
...
cp "$ROOT/.pi/extensions/lib/fm-pi-tool-result-images.ts" "$TMP_ROOT/lib/fm-pi-tool-result-images.ts"
