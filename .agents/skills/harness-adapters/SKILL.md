...
The same shared Pi and pi-signed primary extension also owns the provider-request image normalization boundary documented in [`docs/architecture.md`](../../../docs/architecture.md#pi-primary-tool-result-image-boundary).
