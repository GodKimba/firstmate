...
| `/poolquota`       | Show the local subscription pool's quota and health: a concise per-provider summary of accounts answering, capacity left, and next reset, plus an optional detailed local panel. Read-only, and changes no dispatch or routing |
